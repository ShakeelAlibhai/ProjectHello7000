...
public class Start
{
    ...
    private void start()
    {
        ...
        catch(FileNotFoundException e)
        {
            ...
            welcomeLabel.setForeground(ProjectHello7000.color2);
            ...
            descriptionLabel.setForeground(ProjectHello7000.color2);
            ...
            usernamePanel.setBackground(ProjectHello7000.color1);
            usernamePanel.setLayout(new GridLayout(1, 2));
            JLabel usernameLabel = new JLabel("Username:");
            usernameLabel.setForeground(ProjectHello7000.color2);
            usernameLabel.setFont(ProjectHello7000.bodyText1);
            usernamePanel.add(usernameLabel);
            usernameTextField = new JTextField("");
            usernameTextField.setFont(ProjectHello7000.bodyText1);
            usernameTextField.setForeground(ProjectHello7000.color1);
