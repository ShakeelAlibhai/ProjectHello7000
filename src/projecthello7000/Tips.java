...
public class Tips
{
    ...
    private void disclaimer()
    {
        ...
        disclaimerFrame.setSize(775 * ProjectHello7000.multiplier, 375 * ProjectHello7000.multiplier);
        String output = "1. \"What date is it?\" or \"What time is it?\" - Displays the date and time.\n\n"
                ...
                + "Note: Currently, only the capitals of the 50 U.S. states are supported. Also, accuracy is not guaranteed.";
